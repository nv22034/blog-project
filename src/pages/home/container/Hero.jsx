  ...
  return (
    <section className='container px-auto flex flex-col px-5 py-5 lg:flex-row'>
      <div className='mt-10 lg:w-1/2'>
         <h1 className='font-roboto text-3xl text-center lg:text-left font-bold text-dark-soft md:text-5xl max-w-lg'>Read the most interesting articles</h1>
         <p className='text-dark-light mt-4 text-center lg:text-left md:text-xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua
         </p>
